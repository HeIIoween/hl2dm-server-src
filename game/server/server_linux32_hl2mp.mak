...
FORCEINCLUDES= 
ifeq "$(CFG)" "debug"
DEFINES += -DVPC -DRAD_TELEMETRY_DISABLED -DDEBUG -D_DEBUG -DGNUC -DPOSIX -DCOMPILER_GCC -D_DLL_EXT=.so -D_LINUX -DLINUX -DPOSIX -D_POSIX -DDLLNAME=server -DBINK_VIDEO -DGL_GLEXT_PROTOTYPES -DDX_TO_GL_ABSTRACTION -DUSE_SDL -DDEV_BUILD -DFRAME_POINTER_OMISSION_DISABLED -DGAME_DLL -DVECTOR -DVERSION_SAFE_STEAM_API_INTERFACES -DPROTECTED_THINGS_ENABLE -Dsprintf=use_Q_snprintf_instead_of_sprintf -Dstrncpy=use_Q_strncpy_instead -D_snprintf=use_Q_snprintf_instead -DSWDS -DUSE_NAV_MESH -DHL2MP -DHL2_DLL -D_EXTERNAL_DLL_EXT=.so -DVPCGAMECAPS=HL2MP -DPROJECTDIR=/home/danila/Steam/sdk/mp_10.09.2015/src/game/server -D_DLL_EXT=.so -DSOURCE1=1 -DVPCGAME=hl2mp -D_LINUX=1 -D_POSIX=1 -DLINUX=1 -DPOSIX=1 
else
DEFINES += -DVPC -DRAD_TELEMETRY_DISABLED -DNDEBUG -DGNUC -DPOSIX -DCOMPILER_GCC -D_DLL_EXT=.so -D_LINUX -DLINUX -DPOSIX -D_POSIX -DDLLNAME=server -DBINK_VIDEO -DGL_GLEXT_PROTOTYPES -DDX_TO_GL_ABSTRACTION -DUSE_SDL -DDEV_BUILD -DFRAME_POINTER_OMISSION_DISABLED -DGAME_DLL -DVECTOR -DVERSION_SAFE_STEAM_API_INTERFACES -DPROTECTED_THINGS_ENABLE -Dsprintf=use_Q_snprintf_instead_of_sprintf -Dstrncpy=use_Q_strncpy_instead -D_snprintf=use_Q_snprintf_instead -DSWDS -DUSE_NAV_MESH -DHL2MP -DHL2_DLL -D_EXTERNAL_DLL_EXT=.so -DVPCGAMECAPS=HL2MP -DPROJECTDIR=/home/danila/Steam/sdk/mp_10.09.2015/src/game/server -D_DLL_EXT=_srv.so -DSOURCE1=1 -DVPCGAME=hl2mp -D_LINUX=1 -D_POSIX=1 -DLINUX=1 -DPOSIX=1 
endif
INCLUDEDIRS += ../../common ../../public ../../public/tier0 ../../public/tier1 ../../thirdparty/SDL2 ../../game/server/generated_proto_mod_hl2mp ../../thirdparty/protobuf-2.3.0/src ./ ../../game/shared ../../utils/common ../../game/shared/econ ../../game/server/NextBot ../../game/shared/hl2 ./hl2 ./hl2mp ./episodic ./hl1 ./hl2mp.ru ../../game/shared/hl2mp 
CONFTYPE=dll
IMPORTLIBRARY=
...
$(OBJ_DIR)/point_teleport.o : $(PWD)/../../game/server/hl2mp.ru/point_teleport.cpp $(THIS_MAKEFILE) $(MAKEFILE_BASE)
	$(PRE_COMPILE_FILE)
	$(COMPILE_FILE) $(POST_COMPILE_FILE)

ifneq (clean, $(findstring clean, $(MAKECMDGOALS)))
-include $(OBJ_DIR)/point_teleport.P
endif

$(OBJ_DIR)/point_trigger.o : $(PWD)/../../game/server/hl2mp.ru/point_trigger.cpp $(THIS_MAKEFILE) $(MAKEFILE_BASE)
	$(PRE_COMPILE_FILE)
	$(COMPILE_FILE) $(POST_COMPILE_FILE)

ifneq (clean, $(findstring clean, $(MAKECMDGOALS)))
-include $(OBJ_DIR)/point_trigger.P
endif

$(OBJ_DIR)/hl1mp_weapon_hornetgun.o : $(PWD)/../../game/server/hl1/hl1mp_weapon_hornetgun.cpp $(THIS_MAKEFILE) $(MAKEFILE_BASE)
	$(PRE_COMPILE_FILE)
	$(COMPILE_FILE) $(POST_COMPILE_FILE)
...
$(OBJ_DIR)/trigger_player_count.o : $(PWD)/../../game/server/hl2mp.ru/trigger_player_count.cpp $(THIS_MAKEFILE) $(MAKEFILE_BASE)
	$(PRE_COMPILE_FILE)
	$(COMPILE_FILE) $(POST_COMPILE_FILE)

ifneq (clean, $(findstring clean, $(MAKECMDGOALS)))
-include $(OBJ_DIR)/trigger_player_count.P
endif

$(OBJ_DIR)/weapon_hl2mp_flaregun.o : $(PWD)/../../game/server/hl2mp.ru/weapon_hl2mp_flaregun.cpp $(THIS_MAKEFILE) $(MAKEFILE_BASE)
	$(PRE_COMPILE_FILE)
	$(COMPILE_FILE) $(POST_COMPILE_FILE)

ifneq (clean, $(findstring clean, $(MAKECMDGOALS)))
-include $(OBJ_DIR)/weapon_hl2mp_flaregun.P
endif

$(OBJ_DIR)/weapon_hl2mp_gauss.o : $(PWD)/../../game/server/hl2mp.ru/weapon_hl2mp_gauss.cpp $(THIS_MAKEFILE) $(MAKEFILE_BASE)
	$(PRE_COMPILE_FILE)
	$(COMPILE_FILE) $(POST_COMPILE_FILE)

ifneq (clean, $(findstring clean, $(MAKECMDGOALS)))
-include $(OBJ_DIR)/weapon_hl2mp_gauss.P
endif

$(OBJ_DIR)/weapon_sniperrifle.o : $(PWD)/../../game/server/hl2/weapon_sniperrifle.cpp $(THIS_MAKEFILE) $(MAKEFILE_BASE)
	$(PRE_COMPILE_FILE)
	$(COMPILE_FILE) $(POST_COMPILE_FILE)

ifneq (clean, $(findstring clean, $(MAKECMDGOALS)))
-include $(OBJ_DIR)/weapon_sniperrifle.P
endif

$(OBJ_DIR)/hl2mp_player_fix.o : $(PWD)/../../game/server/hl2mp.ru/hl2mp_player_fix.cpp $(THIS_MAKEFILE) $(MAKEFILE_BASE)
	$(PRE_COMPILE_FILE)
	$(COMPILE_FILE) $(POST_COMPILE_FILE)

ifneq (clean, $(findstring clean, $(MAKECMDGOALS)))
-include $(OBJ_DIR)/hl2mp_player_fix.P
endif

$(OBJ_DIR)/grenade_energy.o : $(PWD)/../../game/server/hl2mp.ru/grenade_energy.cpp $(THIS_MAKEFILE) $(MAKEFILE_BASE)
	$(PRE_COMPILE_FILE)
	$(COMPILE_FILE) $(POST_COMPILE_FILE)

ifneq (clean, $(findstring clean, $(MAKECMDGOALS)))
-include $(OBJ_DIR)/grenade_energy.P
endif

$(OBJ_DIR)/npc_mortarsynth.o : $(PWD)/../../game/server/hl2mp.ru/npc_mortarsynth.cpp $(THIS_MAKEFILE) $(MAKEFILE_BASE)
	$(PRE_COMPILE_FILE)
	$(COMPILE_FILE) $(POST_COMPILE_FILE)

ifneq (clean, $(findstring clean, $(MAKECMDGOALS)))
-include $(OBJ_DIR)/npc_mortarsynth.P
endif

$(OBJ_DIR)/info_vehicle_spawn.o : $(PWD)/../../game/server/hl2mp.ru/info_vehicle_spawn.cpp $(THIS_MAKEFILE) $(MAKEFILE_BASE)
	$(PRE_COMPILE_FILE)
	$(COMPILE_FILE) $(POST_COMPILE_FILE)

ifneq (clean, $(findstring clean, $(MAKECMDGOALS)))
-include $(OBJ_DIR)/info_vehicle_spawn.P
endif

$(OBJ_DIR)/charge_token.o : $(PWD)/../../game/server/hl2mp.ru/charge_token.cpp $(THIS_MAKEFILE) $(MAKEFILE_BASE)
	$(PRE_COMPILE_FILE)
	$(COMPILE_FILE) $(POST_COMPILE_FILE)

ifneq (clean, $(findstring clean, $(MAKECMDGOALS)))
-include $(OBJ_DIR)/charge_token.P
endif

$(OBJ_DIR)/info_player_hl2mpru.o : $(PWD)/../../game/server/hl2mp.ru/info_player_hl2mpru.cpp $(THIS_MAKEFILE) $(MAKEFILE_BASE)
	$(PRE_COMPILE_FILE)
	$(COMPILE_FILE) $(POST_COMPILE_FILE)

ifneq (clean, $(findstring clean, $(MAKECMDGOALS)))
-include $(OBJ_DIR)/info_player_hl2mpru.P
endif

$(OBJ_DIR)/hl1_npc_snark.o : $(PWD)/../../game/server/hl1/hl1_npc_snark.cpp $(THIS_MAKEFILE) $(MAKEFILE_BASE)
	$(PRE_COMPILE_FILE)
	$(COMPILE_FILE) $(POST_COMPILE_FILE)
...
$(OBJ_DIR)/vehicle_jeep_episodic.o : $(PWD)/../../game/server/hl2mp.ru/vehicle_jeep_episodic.cpp $(THIS_MAKEFILE) $(MAKEFILE_BASE)
	$(PRE_COMPILE_FILE)
	$(COMPILE_FILE) $(POST_COMPILE_FILE)
...
$(OBJ_DIR)/weapon_scripted.o : $(PWD)/../../game/server/hl2mp.ru/weapon_scripted.cpp $(THIS_MAKEFILE) $(MAKEFILE_BASE)
	$(PRE_COMPILE_FILE)
	$(COMPILE_FILE) $(POST_COMPILE_FILE)

ifneq (clean, $(findstring clean, $(MAKECMDGOALS)))
-include $(OBJ_DIR)/weapon_scripted.P
endif

$(OBJ_DIR)/npc_antliongrub.o : $(PWD)/../../game/server/hl2mp.ru/npc_antliongrub.cpp $(THIS_MAKEFILE) $(MAKEFILE_BASE)
	$(PRE_COMPILE_FILE)
	$(COMPILE_FILE) $(POST_COMPILE_FILE)
...
$(OBJ_DIR)/info_npc_random.o : $(PWD)/../../game/server/hl2mp.ru/info_npc_random.cpp $(THIS_MAKEFILE) $(MAKEFILE_BASE)
	$(PRE_COMPILE_FILE)
	$(COMPILE_FILE) $(POST_COMPILE_FILE)

ifneq (clean, $(findstring clean, $(MAKECMDGOALS)))
-include $(OBJ_DIR)/info_npc_random.P
endif

$(OBJ_DIR)/hl1_npc_bigmomma.o : $(PWD)/../../game/server/hl1/hl1_npc_bigmomma.cpp $(THIS_MAKEFILE) $(MAKEFILE_BASE)
	$(PRE_COMPILE_FILE)
	$(COMPILE_FILE) $(POST_COMPILE_FILE)
...
$(OBJ_DIR)/hl1_npc_hgrunt.o : $(PWD)/../../game/server/hl1/hl1_npc_hgrunt.cpp $(THIS_MAKEFILE) $(MAKEFILE_BASE)
	$(PRE_COMPILE_FILE)
	$(COMPILE_FILE) $(POST_COMPILE_FILE)
...
$(OBJ_DIR)/hl1_npc_controller.o : $(PWD)/../../game/server/hl1/hl1_npc_controller.cpp $(THIS_MAKEFILE) $(MAKEFILE_BASE)
	$(PRE_COMPILE_FILE)
	$(COMPILE_FILE) $(POST_COMPILE_FILE)
...
$(OBJ_DIR)/hl1_npc_agrunt.o : $(PWD)/../../game/server/hl1/hl1_npc_agrunt.cpp $(THIS_MAKEFILE) $(MAKEFILE_BASE)
	$(PRE_COMPILE_FILE)
	$(COMPILE_FILE) $(POST_COMPILE_FILE)
...
$(OBJ_DIR)/hl1_npc_hornet.o : $(PWD)/../../game/server/hl1/hl1_npc_hornet.cpp $(THIS_MAKEFILE) $(MAKEFILE_BASE)
	$(PRE_COMPILE_FILE)
	$(COMPILE_FILE) $(POST_COMPILE_FILE)
...
$(OBJ_DIR)/hl1_npc_hassassin.o : $(PWD)/../../game/server/hl1/hl1_npc_hassassin.cpp $(THIS_MAKEFILE) $(MAKEFILE_BASE)
	$(PRE_COMPILE_FILE)
	$(COMPILE_FILE) $(POST_COMPILE_FILE)
...
$(OBJ_DIR)/hl1_npc_ichthyosaur.o : $(PWD)/../../game/server/hl1/hl1_npc_ichthyosaur.cpp $(THIS_MAKEFILE) $(MAKEFILE_BASE)
	$(PRE_COMPILE_FILE)
	$(COMPILE_FILE) $(POST_COMPILE_FILE)
...
$(OBJ_DIR)/npc_portal_turret_floor.o : $(PWD)/../../game/server/hl2mp.ru/npc_portal_turret_floor.cpp $(THIS_MAKEFILE) $(MAKEFILE_BASE)
	$(PRE_COMPILE_FILE)
	$(COMPILE_FILE) $(POST_COMPILE_FILE)
...
$(OBJ_DIR)/hl1_npc_bullsquid.o : $(PWD)/../../game/server/hl1/hl1_npc_bullsquid.cpp $(THIS_MAKEFILE) $(MAKEFILE_BASE)
	$(PRE_COMPILE_FILE)
	$(COMPILE_FILE) $(POST_COMPILE_FILE)
...
$(OBJ_DIR)/hl1_npc_houndeye.o : $(PWD)/../../game/server/hl1/hl1_npc_houndeye.cpp $(THIS_MAKEFILE) $(MAKEFILE_BASE)
	$(PRE_COMPILE_FILE)
	$(COMPILE_FILE) $(POST_COMPILE_FILE)
...
$(OBJ_DIR)/hl1_ai_basenpc.o : $(PWD)/../../game/server/hl1/hl1_ai_basenpc.cpp $(THIS_MAKEFILE) $(MAKEFILE_BASE)
	$(PRE_COMPILE_FILE)
	$(COMPILE_FILE) $(POST_COMPILE_FILE)
...
$(OBJ_DIR)/hl1_npc_gargantua.o : $(PWD)/../../game/server/hl1/hl1_npc_gargantua.cpp $(THIS_MAKEFILE) $(MAKEFILE_BASE)
	$(PRE_COMPILE_FILE)
	$(COMPILE_FILE) $(POST_COMPILE_FILE)
...
$(OBJ_DIR)/info_spawn_manager.o : $(PWD)/../../game/server/hl2mp.ru/info_spawn_manager.cpp $(THIS_MAKEFILE) $(MAKEFILE_BASE)
	$(PRE_COMPILE_FILE)
	$(COMPILE_FILE) $(POST_COMPILE_FILE)

ifneq (clean, $(findstring clean, $(MAKECMDGOALS)))
-include $(OBJ_DIR)/info_spawn_manager.P
endif

$(OBJ_DIR)/npc_merchant.o : $(PWD)/../../game/server/hl2mp.ru/npc_merchant.cpp $(THIS_MAKEFILE) $(MAKEFILE_BASE)
	$(PRE_COMPILE_FILE)
	$(COMPILE_FILE) $(POST_COMPILE_FILE)

ifneq (clean, $(findstring clean, $(MAKECMDGOALS)))
-include $(OBJ_DIR)/npc_merchant.P
endif

$(OBJ_DIR)/npc_combine_cannon.o : $(PWD)/../../game/server/episodic/npc_combine_cannon.cpp $(THIS_MAKEFILE) $(MAKEFILE_BASE)
	$(PRE_COMPILE_FILE)
	$(COMPILE_FILE) $(POST_COMPILE_FILE)
...
$(OBJ_DIR)/grenade_spit.o : $(PWD)/../../game/server/hl2/grenade_spit.cpp $(THIS_MAKEFILE) $(MAKEFILE_BASE)
	$(PRE_COMPILE_FILE)
	$(COMPILE_FILE) $(POST_COMPILE_FILE)
...
$(OBJ_DIR)/npc_hunter.o : $(PWD)/../../game/server/hl2mp.ru/npc_hunter.cpp $(THIS_MAKEFILE) $(MAKEFILE_BASE)
	$(PRE_COMPILE_FILE)
	$(COMPILE_FILE) $(POST_COMPILE_FILE)
...
$(OBJ_DIR)/weapon_striderbuster.o : $(PWD)/../../game/server/hl2mp.ru/weapon_striderbuster.cpp $(THIS_MAKEFILE) $(MAKEFILE_BASE)
	$(PRE_COMPILE_FILE)
	$(COMPILE_FILE) $(POST_COMPILE_FILE)
...
$(OBJ_DIR)/info_player_spawn.o : $(PWD)/../../game/server/hl2mp.ru/info_player_spawn.cpp $(THIS_MAKEFILE) $(MAKEFILE_BASE)
	$(PRE_COMPILE_FILE)
	$(COMPILE_FILE) $(POST_COMPILE_FILE)

ifneq (clean, $(findstring clean, $(MAKECMDGOALS)))
-include $(OBJ_DIR)/info_player_spawn.P
endif

$(OBJ_DIR)/npc_zombine.o : $(PWD)/../../game/server/hl2mp.ru/npc_zombine.cpp $(THIS_MAKEFILE) $(MAKEFILE_BASE)
	$(PRE_COMPILE_FILE)
	$(COMPILE_FILE) $(POST_COMPILE_FILE)
...
$(OBJ_DIR)/game_countdown_timer.o : $(PWD)/../../game/server/hl2mp.ru/game_countdown_timer.cpp $(THIS_MAKEFILE) $(MAKEFILE_BASE)
	$(PRE_COMPILE_FILE)
	$(COMPILE_FILE) $(POST_COMPILE_FILE)

ifneq (clean, $(findstring clean, $(MAKECMDGOALS)))
-include $(OBJ_DIR)/game_countdown_timer.P
endif

$(OBJ_DIR)/weapon_alyxgun.o : $(PWD)/../../game/server/hl2/weapon_alyxgun.cpp $(THIS_MAKEFILE) $(MAKEFILE_BASE)
	$(PRE_COMPILE_FILE)
	$(COMPILE_FILE) $(POST_COMPILE_FILE)
...
$(OBJ_DIR)/vehicle_jeep.o : $(PWD)/../../game/server/hl2/vehicle_jeep.cpp $(THIS_MAKEFILE) $(MAKEFILE_BASE)
	$(PRE_COMPILE_FILE)
	$(COMPILE_FILE) $(POST_COMPILE_FILE)
...
$(OBJ_DIR)/npc_fastzombie.o : $(PWD)/../../game/server/hl2mp.ru/npc_fastzombie.cpp $(THIS_MAKEFILE) $(MAKEFILE_BASE)
	$(PRE_COMPILE_FILE)
	$(COMPILE_FILE) $(POST_COMPILE_FILE)
