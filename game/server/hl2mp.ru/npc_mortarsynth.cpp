...
ConVar	sk_mortarsynth_health( "sk_mortarsynth_health","250");
...
BEGIN_DATADESC( CNPC_MSynth )
	...
	DEFINE_ARRAY( m_pEnergyGlow, FIELD_CLASSPTR, MSYNTH_NUM_GLOWS ),

	DEFINE_FIELD( m_fNextEnergyAttackTime, FIELD_TIME),
