...
ConVar sk_hunter_dmg_flechette( "sk_hunter_dmg_flechette", "8.0" );
...
static ConCommand ent_create("hunter_shoot_flechette_wR6yc25uhl2mpru", CC_Hunter_Shoot_Flechette, "Fires a hunter flechette where the player is looking.", FCVAR_GAMEDLL );
...
{
	PrecacheModel( "models/hl2/hunt.mdl" );
	PropBreakablePrecacheAll( MAKE_STRING("models/hl2/hunt.mdl") );
