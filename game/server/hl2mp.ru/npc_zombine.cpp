...
void CNPC_Zombine::Precache( void )
{
	...
	PrecacheModel( "models/ep2/zombie_soldier.mdl" );
...
{
	SetModel( "models/ep2/zombie_soldier.mdl" );
...
{
	return "models/ep2/zombie_soldier_legs.mdl";
}
...
{
	return "models/ep2/zombie_soldier_torso.mdl";
}
