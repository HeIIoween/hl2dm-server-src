...
public:
	void SetPlayerMP ( CBasePlayer *pPlayer ) { m_phl2mpru = pPlayer; }
	CBasePlayer *GetPlayerMP ( void ) { return m_phl2mpru; }
	const char *GetCustomName ( void ) { return m_iszCustomID; }
