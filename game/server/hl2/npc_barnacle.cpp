...
bool CNPC_Barnacle::CanPickup( CBaseCombatCharacter *pBCC )
{
	...
	if( pBCC->GetPlayerMP() || FClassnameIs( pBCC, "npc_turret_floor" ) || FClassnameIs( pBCC, "npc_rollermine" ) || FClassnameIs( pBCC, "npc_portal_turret_floor" ) || FClassnameIs( pBCC, "npc_portal_turret_rpg" ) || FClassnameIs( pBCC, "npc_manhack" ) || FClassnameIs( pBCC, "hornet" ) )
		return false;
