...
//LINK_ENTITY_TO_CLASS(weapon_flaregun, CItem_BoxFlareRounds);
...
{
	"models/items/ammocrate_smg1.mdl",	// Small rounds
	...
	"models/items/ammocrate_smg1.mdl",	// Buckshot
	...
	"models/items/ammocrate_smg1.mdl",	    // smg grenade
};
...
void CItem_AmmoCrate::Use( CBaseEntity *pActivator, CBaseEntity *pCaller, USE_TYPE useType, float value )
{
	...
	if ( pPlayer == NULL || m_flCloseTime > gpGlobals->curtime - 0.5 )
		return;
