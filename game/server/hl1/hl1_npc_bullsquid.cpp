...
ConVar sk_bullsquid_health ( "sk_bullsquid_health", "150" );
ConVar sk_bullsquid_dmg_bite ( "sk_bullsquid_dmg_bite", "30" );
ConVar sk_bullsquid_dmg_whip ( "sk_bullsquid_dmg_whip", "35" );
ConVar sk_bullsquid_dmg_spit ( "sk_bullsquid_dmg_spit", "80" );
...
void CSquidSpit::Precache( void )
{
	...
	PrecacheScriptSound( "Bullsquid.SpitTouch1" );
	PrecacheScriptSound( "Bullsquid.SpitHit1" );
	PrecacheScriptSound( "Bullsquid.SpitHit2" );
}
...
void CSquidSpit::Touch ( CBaseEntity *pOther )
{
	...
	EmitSound( "Bullsquid.SpitTouch1" );

	switch ( random->RandomInt( 0, 1 ) )
	{
	case 0:
		EmitSound( "Bullsquid.SpitHit1" );
		break;
	case 1:
		EmitSound( "Bullsquid.SpitHit2" );
		break;
	}
...
void CNPC_Bullsquid::Spawn()
{
	...
	SetModel( "models/hl2/bullsquid.mdl");
...
void CNPC_Bullsquid::Precache()
{
	...
	PrecacheModel("models/hl2/bullsquid.mdl");
