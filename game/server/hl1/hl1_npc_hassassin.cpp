...
ConVar sk_hassassin_health( "sk_hassassin_health", "200" );
...
LINK_ENTITY_TO_CLASS( npc_hassassin, CNPC_HAssassin );
...
void CNPC_HAssassin::Spawn()
{
	...
	SetModel( "models/hl2/hassassin.mdl");
...
void CNPC_HAssassin::Precache()
{
	...
	PrecacheModel("models/hl2/hassassin.mdl");
	...
	case ASSASSIN_AE_TOSS1:
		{
			...
			Fraggrenade_Create( vTossPos, vec3_angle, m_vecTossVelocity, vec3_origin, this, 3.5, true );
