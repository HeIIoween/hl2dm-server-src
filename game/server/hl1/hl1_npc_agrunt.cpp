...
ConVar sk_agrunt_health( "sk_agrunt_health", "150" );
ConVar sk_agrunt_dmg_punch( "sk_agrunt_dmg_punch", "30" );
...
void CNPC_AlienGrunt::Spawn()
{
	...
	SetModel( "models/hl2/agrunt.mdl");
...
{
	PrecacheModel("models/hl2/agrunt.mdl");
