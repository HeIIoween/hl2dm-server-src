...
ConVar sk_controller_health ( "sk_controller_health", "200" );
ConVar sk_controller_dmgzap ( "sk_controller_dmgzap", "60" );
ConVar sk_controller_speedball ( "sk_controller_speedball", "1300" );
ConVar sk_controller_dmgball ( "sk_controller_dmgball", "40" );
...
void CNPC_Controller::Spawn()
{
	...
	SetModel( "models/hl2/controller.mdl" );
...
{
	PrecacheModel("models/hl2/controller.mdl");
