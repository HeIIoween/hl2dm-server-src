...
ConVar sk_snark_health		( "sk_snark_health",				"80" );
ConVar sk_snark_dmg_bite	( "sk_snark_dmg_bite",				"35" );
ConVar sk_snark_dmg_pop		( "sk_snark_dmg_pop",				"50" );
...
void CSnark::Precache( void )
{
	...
	PrecacheModel( "models/hl1/w_squeak2.mdl" );
...
void CSnark::Spawn( void )
{
	...
	SetModel( "models/hl1/w_squeak2.mdl" );
