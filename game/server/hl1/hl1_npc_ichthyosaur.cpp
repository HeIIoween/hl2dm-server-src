...
ConVar sk_ichthyosaur_health ( "sk_ichthyosaur_health", "750" );
ConVar sk_ichthyosaur_shake ( "sk_ichthyosaur_shake", "40" );
...
{
	PrecacheModel("models/ichthyosaur.mdl");
...
void CNPC_Ichthyosaur::Spawn( void )
{
	...
	SetModel( "models/ichthyosaur.mdl");
