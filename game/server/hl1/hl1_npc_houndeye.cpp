...
#define	HOUNDEYE_MAX_ATTACK_RADIUS		512
...
ConVar sk_houndeye_health ( "sk_houndeye_health", "500" );
ConVar sk_houndeye_dmg_blast ( "sk_houndeye_dmg_blast", "100" );
...
void CNPC_Houndeye::Spawn()
{
	...
	SetModel( "models/hl2/houndeye.mdl" );
...
{
	PrecacheModel("models/hl2/houndeye.mdl");
...
int CNPC_Houndeye::MeleeAttack1Conditions ( float flDot, float flDist )
{
